...
export function WithoutStartTransition() {
        ...
        >
          ...
          {boxes.map((box, index) => {
            return (
              ...
              >
                <div
                  className="absolute h-full w-1 right-0"
                  style={{
                    backgroundColor:
                      boxTypes[index] === "light"
                        ? "blue"
                ...
                <div className="absolute h-full w-1 right-1 bg-[#E6605F]" />
                <div className="absolute h-full w-1 left-0 bg-[#E6605F]" />
              </div>
            );
          })}
        </div>
